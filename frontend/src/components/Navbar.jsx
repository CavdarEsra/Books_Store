...
function Navbar({containerStyles, toggleMenu, menuOpened}) {
  ...
  const navItems = [
    ...
    {to: 'mailto:esracavdar470@gmail.com', label: 'Contact', icon: <IoMailOpen/>}

  ]

  return (
    // NavLink bileşeni, React Router'a ait bir bileşendir ve her tıklamada URL'nin değişmesini sağlar.  
      ...
      {menuOpened && (
        <>
          ...
          <Link to={'/'} className='bold-24 mb-10'>
            <h4 className='text-secondary '>Mokka</h4>
          </Link>
        </>
      )}
